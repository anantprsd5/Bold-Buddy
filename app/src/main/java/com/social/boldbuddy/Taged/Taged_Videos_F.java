package com.social.boldbuddy.Taged;
...
import com.social.boldbuddy.Home.Home_Get_Set;
import com.social.boldbuddy.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.social.boldbuddy.Profile.MyVideos_Adapter;
...
import com.social.boldbuddy.WatchVideos.WatchVideos_F;
...
public class Taged_Videos_F extends RootFragment {
    ...
    private void Call_Api_For_get_Allvideos() {
        ...
        try {
            ...
            parameters.put("token", Variables.sharedPreferences.getString(Variables.device_token,""));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.SearchByHashTag, parameters, new Response.Listener<JSONObject>() {
