...
public class Variables {
    ...
    public static String file_provider_path = "com.social.boldbuddy.fileprovider";
    ...
    public static String domain = "http://boldbuddy.midbrains.in/API/index.php?p=";
    public static String base_url = "http://boldbuddy.midbrains.in/API/";
