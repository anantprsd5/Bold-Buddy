package com.social.boldbuddy.SimpleClasses;
...
import com.social.boldbuddy.Comments.Comment_Get_Set;
...
public class Functions {
    ...
    public static void Call_Api_For_like_video(final Activity activity,
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.likeDislikeVideo, parameters, new Response.Listener<JSONObject>() {

                    @Override
                    public void onResponse(JSONObject response) {
                        String respo=response.toString();
                        Log.d("responce",respo);
                        api_callBack.OnSuccess(respo);
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        // TODO: Handle error
                        api_callBack.OnFail(error.toString());
    ...
    public static void Call_Api_For_Send_Comment(final Activity activity, String video_id,String comment ,final API_CallBack api_callBack) {
        ...
        RequestQueue rq = Volley.newRequestQueue(activity);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.postComment, parameters, new Response.Listener<JSONObject>() {
    ...
    public static void Call_Api_For_get_Comment(final Activity activity, String video_id, final API_CallBack api_callBack) {
        ...
        RequestQueue rq = Volley.newRequestQueue(activity);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.showVideoComments, parameters, new Response.Listener<JSONObject>() {
    ...
    public static void Call_Api_For_update_view(final Activity activity,
        ...
        RequestQueue rq = Volley.newRequestQueue(activity);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.updateVideoView, parameters, new Response.Listener<JSONObject>() {
    ...
    public static void Call_Api_For_Follow_or_unFollow
        ...
        RequestQueue rq = Volley.newRequestQueue(activity);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.follow_users, parameters, new Response.Listener<JSONObject>() {
    ...
    public static void Call_Api_For_Get_User_data
        ...
        RequestQueue rq = Volley.newRequestQueue(activity);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.POST, Variables.get_user_data, parameters, new Response.Listener<JSONObject>() {
